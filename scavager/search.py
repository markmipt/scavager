...
def run():
    ...
    parser.add_argument('-i', '--infix', help='decoy infix if database was generated by SearchGUI')
    ...
    parser.add_argument('-ap', '--allowed-peptides', help='Path to file with peptides considered '
    ...
    parser.add_argument('-gp', '--group-prefix', help='Protein prefix for group-specific filtering. '
